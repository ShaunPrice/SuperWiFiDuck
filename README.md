...
This project is a fork of [Super WiFi Duck](https://github.com/wasdwasd0105/SuperWiFiDuck) to customize it for a Lolin ESP32-S3. [Super WiFi Duck](https://github.com/wasdwasd0105/SuperWiFiDuck) is itself a fork of [WiFi Duck](https://github.com/SpacehuhnTech/WiFiDuck) that utilizes the native USB function of ESP32 S2/3 chip to allow it to run WiFi Duck with a default module below 10$, and no special hardware work is required.

ESP32 S2/S3 can emulate multiple USB devices at the same time. So I want to add USB mouse and USB disk function in the future. But it depends on how much time/money I have.
