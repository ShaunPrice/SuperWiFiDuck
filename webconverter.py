...
def main():
    ...
    # If the esp_duck directory doesn't exist, create it
    if not os.path.exists("esp_duck"):
        os.makedirs("esp_duck")
    ...
    # Append the date and time of the last build as a C++ comment
    outputfile.write(f"// Built: {datetime.datetime.now()}\n\n")
    ...
    print("Done!")
    print("=====================================")
    print("You can find the generated file in the esp_duck folder")
    print("Copy the esp_duck folder to your Arduino src folder")
    print("You can now upload the sketch to your ESP32")
